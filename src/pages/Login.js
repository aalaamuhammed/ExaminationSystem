...
const ReactHookFormDemo = () => {
    ...
    const onSubmit = async (data) => {
        try {
            ...
            if (res.status === 200) {
                ...
                console.log(1, axiosInstance.defaults);
                navigate('/Home')
    ...
    return (
        <div style={{
            display: "flex",
            backgroundImage: "linear-gradient(to bottom right, #4364F7, #6FB1FC,#6FB1FC)",
            height: "100vh",
            justifyContent: 'center',
             paddingTop:"20vh",
            
        }}>
            <div className="form-demo" style={{  height:'50%'}}>
                            ...
                            <div className="field">
                                <span className="p-float-label">
                                    <Controller name="password" control={control} rules={{ required: 'Password is required.' }} render={({ field, fieldState }) => (
                                        <Password id={field.name} placeholder="Password" {...field} toggleMask className={classNames({ 'p-invalid': fieldState.invalid })} header={passwordHeader} />
                                    )} />
